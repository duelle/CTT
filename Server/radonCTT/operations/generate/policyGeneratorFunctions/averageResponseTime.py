...
from radonCTT.operations.generate.nodeGeneratorFunctions import lambdaFunction, s3Bucket

#------------------------------------------------------|
def generatePolicyTest(project, testartifact, policy):
    """
    This is a policy generator function for the averageResponseTime performance policy type.
    ...
    functionSwitch = {
        ...
        # AWSLambda
        'radon.nodes.aws.LambdaFunction': lambdaFunction.generateNodeTest,

        # S3Bucket
        'radon.nodes.aws.S3Bucket' : s3Bucket.generateNodeTest,
    }
